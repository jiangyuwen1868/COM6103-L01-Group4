 ...
 */
package com.jyw.csp.api.configure;
...
public class PathUtils {
    ...
    public static String cleanPath(String path) {
        ...
        String pathToUse = path.replaceAll("\\" + ResourceConstants.WINDOWS_FOLDER_SEPARATOR.getValue(), ResourceConstants.FOLDER_SEPARATOR.getValue());
        ...
        String[] pathArray = pathToUse.split(ResourceConstants.FOLDER_SEPARATOR.getValue());
        ...
        return prefix + join(pathElements, ResourceConstants.FOLDER_SEPARATOR.getValue());
    }
